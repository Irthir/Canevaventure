...
public class Dessinable : MonoBehaviour
{
    [SerializeField]
    private static Color Couleur = Color.black;
    //Couleur du pinceau.
    [SerializeField]
    private static int Largeur = 1;
    //Largeur du pinceau.
    ...
    public static Dessinable drawable;
...
// BRUSH TYPES. Implement your own here
    ...
    public void BrushTemplate(Vector2 world_position)
    {
        ...
        if (previous_drag_position == Vector2.zero)
        {
            ...
            MarkPixelsToColour(pixel_pos, Largeur, Couleur);
        }
        else
        {
            // THE USER IS DRAGGING
            // Should we do stuff between the previous mouse position and the current one?
            ColourBetween(previous_drag_position, pixel_pos, Largeur, Couleur);
        }
        ////////////////////////////////////////////////////////////////
    ...
    // Changes the surrounding pixels of the world_point to the static Couleur
